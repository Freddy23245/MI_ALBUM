...
<header class="p-3 mb-3 border-bottom">
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 justify-content-end" role="">
...
<body>
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      ...
                      <form action="EliminarImagen.php" method="post">
                        <input type="hidden" name="Foto12" value="<?php echo $p['imagen'] ?>">
  ...
  <footer class="text-body-secondary py-5 bg-dark">
    <div class="container">
      ...
      <p class="mb-1 text-white">Album example is &copy; Bootstrap, but please download and customize it for yourself!</p>
      <p class="mb-0 text-white">New to Bootstrap? <a href="/">Visit the homepage</a> or read our <a href="../getting-started/introduction/">getting started guide</a>.</p>
    </div>
  </footer>
